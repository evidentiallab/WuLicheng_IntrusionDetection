...
def probabilistic_FitNet4(data_WIDTH, data_HEIGHT, num_class,
    ...
    model_PR.compile(optimizer=keras.optimizers.Nadam(learning_rate=0.01, beta_1=0.9, beta_2=0.999, epsilon=None,
                                                      schedule_decay=0.004), loss='CategoricalCrossentropy',
                     metrics=['accuracy'])
    # model_PR.summary()
    filepath = 'pickleJar/PR_FitNet_lr0.01_bs64'
    filepath1 = 'pickleJar/best/PR_FitNet4_lr0.01_bs64.hdf5'
    ...
    if is_train == 1:
        ...
        plt.legend()
        plt.savefig('pic/PR-FitNet4-epoch-loss(lr0.01bs64).png', dpi=300)
        plt.show()
...
def evidential_FitNet4(data_WIDTH, data_HEIGHT, num_class, prototypes,
                       is_train, is_load,
    ...
    if load_weights == 1:
        ...
        model_evi.load_weights('pickleJar/PR_FitNet_lr0.01_bs64').expect_partial()
    ...
    if train_DS_Layers == 1:
        ...
        model_evi.load_weights('pickleJar/PR_FitNet_lr0.01_bs64').expect_partial()
        DS1_W = tf.reshape(model_mid.layers[1].get_weights()[0], [1, 20, 128])
        ...
        filepath = 'pickleJar/Evidential/EVI_FitNet_lr0.001_bs64'
    ...
    if is_load == 1:
        ...
        model_evi.load_weights('pickleJar/Evidential/EVI_FitNet_lr0.001_bs64').expect_partial()
...
if __name__ == '__main__':
    ...
    evidential_FitNet4(data_WIDTH=10, data_HEIGHT=10, num_class=5,prototypes=20,
