...
#
# DS_filepath = 'pickleJar/Evidential/EVI_FN4S_SMOTE_NSL_100proto_nu1'   # Overwritten by simplifiedFitNet for SMOTE NSL
...
def evidential_FitNet4(data_WIDTH, data_HEIGHT, num_class, prototypes,nu,model_filepath,evi_filepath,mid_filepath,
                       is_load,load_weights, train_DS_Layers, plot_DS_layer_loss,
                       x_train, y_train, x_test, y_test,
                       output_confusion_matrix):
...
def evidential_FitNet4_simplify(data_WIDTH, data_HEIGHT, num_class, prototypes,is_load,nu,
                       model_filepath,load_weights, train_DS_Layers, plot_DS_layer_loss,DS_filepath,
                       x_train, y_train, x_test, y_test,
                       output_confusion_matrix):
...
if __name__ == '__main__':
    ...
    #                    x_test=test_2D, y_test=test_label)
    '''4.20 Fix label errors in the training set'''
    ...
    #                       x_train=train_2D, y_train=train_label, model_filepath=model_filepath,
    #                       x_test=test_2D, y_test=test_label)
    # evidential_FitNet4(data_WIDTH=10, data_HEIGHT=10, num_class=5, prototypes=100, is_load=1,
    #                    load_weights=1, train_DS_Layers=1, plot_DS_layer_loss=0,
    #                    output_confusion_matrix=1,
    #                    x_train=train_2D, y_train=train_label,
    #                    x_test=test_2D, y_test=test_label)
    # evidential_FitNet4_simplify(data_WIDTH=10, data_HEIGHT=10, num_class=5, prototypes=100, nu=0, is_load=1,
